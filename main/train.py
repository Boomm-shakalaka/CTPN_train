...
tf.app.flags.DEFINE_string('checkpoint_path', '/home/cjy/Desktop/text-detection-ctpn/new_model/', '')#模型输出保存位置
tf.app.flags.DEFINE_string('logs_path', 'logs_mlt/', '')
tf.app.flags.DEFINE_string('pretrained_model_path', '/home/cjy/Desktop/text-detection-ctpn/data/vgg_16.ckpt', '')
tf.app.flags.DEFINE_boolean('restore', False, '')#默认为TRUE，会有问题，80行报错
tf.app.flags.DEFINE_integer('save_checkpoint_steps', 10000, '')#多少次数保存一次模型
